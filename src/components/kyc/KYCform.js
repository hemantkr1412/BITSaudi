	...
	return (
		<div className="individualpage">
			<div className="individualformcontainer">
				...
				/>
				<label htmlFor="name">
					{t("kycPage.kycForm.desciptionLabel")}
				</label>
				<input
					type="text"
					id="name"
				...
				/>
				<label htmlFor="email">
					{t("kycPage.kycForm.countryLabel")}
				</label>
				<input
					type="text"
					id="email"
				...
				/>
				<label htmlFor="email">
					{t("kycPage.kycForm.officialWebsiteLabel")}
				</label>
				<input
					type="email"
					id="email"
					...
					name="website"
					placeholder={t(
						"kycPage.kycForm.officialWebsitePlaceholder"
					)}
				...
				<h4
					...
					{t("kycPage.kycForm.subheading")}
				</h4>
				<label htmlFor="Official website">
					{t("kycPage.kycForm.nameOfissuerLabel")}
				</label>
				<input
					type="text"
					id="phone_num"
				...
				/>
				<label htmlFor="Official website">
					{t("kycPage.kycForm.lastnameOfissuerLabel")}
				</label>
				<input
					type="text"
					id="phone_num"
					...
					name="name"
					placeholder={t(
						"kycPage.kycForm.lastnameOfissuerPlaceholder"
					)}
					onChange={(e) => setIssuerLastName(e.target.value)}
				/>
				<label htmlFor="Official website">
					{t("kycPage.kycForm.designationOfissuerLabel")}
				</label>
				<input
					type="text"
					id="phone_num"
					...
					name="name"
					placeholder={t(
						"kycPage.kycForm.designationOfissuerPlaceholder"
					)}
					onChange={(e) => setIssuerJobDesignation(e.target.value)}
				/>
				<label htmlFor="Official website">
					{t("kycPage.kycForm.officialEmailLabel")}
				</label>
				<input
					type="text"
					id="phone_num"
				...
				<label htmlFor="website">
					{t("kycPage.kycForm.officialPhoneLabel")}
				</label>
				<input
					type="number"
					id="website"
        ...
        /> */}
				...
				<h4
					...
					{t("kycPage.kycForm.subheadingnote")}
				</h4>
				<label htmlFor="fileselectorinput">
				...
				<div
						...
						<div
							...
							<div style={{ textAlign: "left" }}>
								<div
									...
									{t(
										"kycPage.kycForm.approve_authority_name"
									)}
								...
								<div
									...
									{t(
										"kycPage.kycForm.approve_authority_Designation"
									)}
								...
								<div
									...
									{t(
										"kycPage.kycForm.approve_authority_email"
									)}
					...
					<button onClick={() => setApproverDialog(true)}>
						{t("kycPage.kycForm.add_approver")}
					</button>
				</div>
			...
			<Dialog
				onClose={() => setApproverDialog(false)}
				open={approverDialog}>
				<div
					style={{
						padding: "40px",
					...
					<div
						...
						<label htmlFor="add-approver-name">
					...
					<div
						...
						<label htmlFor="add-approver-last-name">
							{t("kycPage.kycForm.approve_authority_lastname")}
						</label>
					...
					<div
						...
						<label htmlFor="add-approver-designation">
					...
					<div
						...
						<label htmlFor="add-approver-email">
