...
const TryForFree = () => {
  ...
  const handleSubmit = () => {
    ...
    tryforfreeApi({
      ...
      .then((res) => {
        setStatus("");
        alert("Thank you for choosing bitmemoir. Our representative will contact you shortly.");
        navigate("/home");
      })
      .catch((err) => {
        setStatus("");
        alert("Something went wrong. Please contact us at support@beimagine.tech");
      });
  };
  return (
    <div
