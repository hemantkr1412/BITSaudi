    ...
    return (
        ...
        <motion.div
                ...
                <div className='flex flex-col md:flex-row  items-center w-[80vw] mx-auto mt-20'>
                    <motion.div
                        ...
                        <div className="content">
                            ...
                            Available as a browser extension and as a mobile app, BitWallet equips you with a key vault, secure login, simple NFT and Crypto storage and transfer.
                            </p>
                        </div>
                    </motion.div>
                    <motion.div
            ...
            <div id='main_content2'  className="sm:w-[80vw] main_content2 mt-28 border shadow-2xl border-purple-900 rounded-xl bg-gray-700">
                <h1 className="text-center text-white text-4xl font-bold py-3">BitWallet Download</h1>
                <div
            ...
            <div className="main_content3">
                <div className='flex flex-col items-center md:w-[80vw] mx-auto mt-28'>
                    ...
                    <div className="order-2">
                        ...
                        {
                            <iframe width="560" height="315" src="https://www.youtube.com/embed/YDsqedqmF84" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe> 
                        }
