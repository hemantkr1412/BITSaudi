...
const CertDesigner = (props) => {
	...
	if (isPreview)
		return (
			<CertPreview certData={certDataForPreview} setOpen={setIsPreview} />
		);

	return (
		<div className="designCertPage">
			<h1>{t("Institutions.certDesigner.heading")}</h1>
			<h3>{t("Institutions.certDesigner.edit")}</h3>
			<div
				...
				{backgroundColorPicker && (
					<div className="colorPicker">
						<h2>{t("Institutions.certDesigner.bgcolor")}</h2>
						<SketchPicker
							color={certColor}
							onChangeComplete={(color) =>
								setCertColor(color["hex"])
							}
						/>
						<h1 onClick={() => setbackgroundColorPicker(false)}>
							X
						</h1>
					</div>
				)}
				...
				{fontColorPicker && (
					<div className="colorPicker">
						<h2>{t("Institutions.certDesigner.fontcolor")}</h2>
						<SketchPicker
							color={fontColor}
							onChangeComplete={(color) =>
				...
				<img
					...
					onClick={() =>
						document.getElementById("logo1-selector").click()
					}
				/>
				<img
					src={logo2}
					...
					onClick={() =>
						document.getElementById("logo2-selector").click()
					}
				/>
				<input
					type="text"
				...
				<div
					...
					<img
						...
						width={textHeight * 20}
						onClick={() =>
							document.getElementById("sign1-selector").click()
						}
					/>
					<input
						type="text"
				...
				<div
					...
					<img
						...
						width={textHeight * 20}
						onClick={() =>
							document.getElementById("sign2-selector").click()
						}
					/>
					<input
						type="text"
				...
				<div
					...
					<img
						...
						width={textHeight * 20}
						onClick={() =>
							document.getElementById("sign3-selector").click()
						}
					/>
					<input
						type="text"
			...
			<div
				...
				<label htmlFor="certificate-template-name">
			...
			<div className="buttonContainer">
				<button onClick={goBack}>
					...
					{t("Institutions.templateCert.back")}
				</button>
				<button
					onClick={() => {
