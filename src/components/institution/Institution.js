...
export const Institution = () => {
	...
	return (
		<div className="institutepage">
			<h1>{t("Institutions.LandingPage.Navbar.Heading")}</h1>
			<div className="instituteLandingForm">
				...
				/>
				<h4>{t("Institutions.certIssue.enterValues")}</h4>
				<button
					onClick={() => {
						let certName =
				...
				<div style={{ marginTop: "50px" }}>
					<h2>{t("Institutions.templateCert.readymadetemplates")}</h2>
					<div
						style={{
							display: "flex",
							gap: "20px",
			...
			<h1>{t("Institutions.badgeIssue.heading")}</h1>
			<div className="instituteLandingForm">
				<label htmlFor="badge-selector">
					{t("Institutions.badgeIssue.selectBadge")}
				</label>
				<select name="template-selector" id="template-selector">
					{Object.keys(user.userData.certificates).map((cert) => (
						<option
				...
				<label htmlFor="certificate-number-selector">
					{t("Institutions.badgeIssue.NoOfBadges")}
				</label>
				<input
					type="number"
